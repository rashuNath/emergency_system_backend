                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="icuNumber" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="latitude" class="gllpLatitude form-control" value="">
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" name="longitude" class="gllpLongitude form-control" value="">
                            </div>
                          </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group" style="margin-top:20px;">
                            <input type="submit" class="btn btn-primary" name="insertHospitalDetails" value="Save">
                        </div>
                    </div>
                </div>
              </form>
