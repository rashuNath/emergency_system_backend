...
<div class="login-box">
  <div class="login-logo">
    <a href="javascript:;"><b>Emergency </b>Services</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <br>
    <a href="#" class="margin-top-bottom-10">I forgot my password</a><br>
    <span>Don't have an account?</span><a href="register.html" class="text-center">Register a new membership</a>
